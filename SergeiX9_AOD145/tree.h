...
// Mon Oct 13 12:17:40 2014 by ROOT version 5.34/18
// from TTree tree/tree
// found on file: input/WSUlocaldataX9_LHC11h_AOD145_167915-004.root
//////////////////////////////////////////////////////////
...
//const Int_t kMaxfTrackGlobal = 3716;
//const Int_t kMaxfTrackHybrid = 2713;
//const Int_t kMaxfTrackTPCnly = 3716;
const Int_t kMaxfTrackGlobal = 5000;
const Int_t kMaxfTrackHybrid = 5000;
const Int_t kMaxfTrackTPCnly = 5000;
...
public :
 ...
 //Event           *fEvent;
   ...
   Float_t         fTrackGlobal_tpcmom[kMaxfTrackGlobal];   //[fTrackGlobal_]
   ...
   Int_t           fTrackGlobal_ncross[kMaxfTrackGlobal];   //[fTrackGlobal_]
   Float_t         fTrackGlobal_chi2ndf[kMaxfTrackGlobal];   //[fTrackGlobal_]
   ...
   Float_t         fTrackHybrid_tpcmom[kMaxfTrackHybrid];   //[fTrackHybrid_]
   ...
   Int_t           fTrackHybrid_ncross[kMaxfTrackHybrid];   //[fTrackHybrid_]
   Float_t         fTrackHybrid_chi2ndf[kMaxfTrackHybrid];   //[fTrackHybrid_]
   ...
   Float_t         fTrackTPCnly_tpcmom[kMaxfTrackTPCnly];   //[fTrackTPCnly_]
   ...
   Int_t           fTrackTPCnly_ncross[kMaxfTrackTPCnly];   //[fTrackTPCnly_]
   Float_t         fTrackTPCnly_chi2ndf[kMaxfTrackTPCnly];   //[fTrackTPCnly_]
   ...
   TBranch        *b_fEvent_ntrk_Global;   //!
   TBranch        *b_fEvent_ntrk_Hybrid;   //!
   TBranch        *b_fEvent_ntrk_TPCnly;   //!
   ...
   TBranch        *b_fTrackGlobal_ncross;   //!
   TBranch        *b_fTrackGlobal_chi2ndf;   //!
   ...
   TBranch        *b_fTrackHybrid_ncross;   //!
   TBranch        *b_fTrackHybrid_chi2ndf;   //!
   ...
   TBranch        *b_fTrackTPCnly_ncross;   //!
   TBranch        *b_fTrackTPCnly_chi2ndf;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("input/WSUlocaldataX9_LHC11h_AOD145_167915-004.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("input/WSUlocaldataX9_LHC11h_AOD145_167915-004.root");
      }
...
void tree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("ntrk_Global", &ntrk_Global, &b_fEvent_ntrk_Global);
   fChain->SetBranchAddress("ntrk_Hybrid", &ntrk_Hybrid, &b_fEvent_ntrk_Hybrid);
   fChain->SetBranchAddress("ntrk_TPCnly", &ntrk_TPCnly, &b_fEvent_ntrk_TPCnly);
   ...
   fChain->SetBranchAddress("fTrackGlobal.tpcmom", fTrackGlobal_tpcmom, &b_fTrackGlobal_tpcmom);
   ...
   fChain->SetBranchAddress("fTrackGlobal.ncross", fTrackGlobal_ncross, &b_fTrackGlobal_ncross);
   fChain->SetBranchAddress("fTrackGlobal.chi2ndf", fTrackGlobal_chi2ndf, &b_fTrackGlobal_chi2ndf);
   ...
   fChain->SetBranchAddress("fTrackHybrid.tpcmom", fTrackHybrid_tpcmom, &b_fTrackHybrid_tpcmom);
   ...
   fChain->SetBranchAddress("fTrackHybrid.ncross", fTrackHybrid_ncross, &b_fTrackHybrid_ncross);
   fChain->SetBranchAddress("fTrackHybrid.chi2ndf", fTrackHybrid_chi2ndf, &b_fTrackHybrid_chi2ndf);
   ...
   fChain->SetBranchAddress("fTrackTPCnly.tpcmom", fTrackTPCnly_tpcmom, &b_fTrackTPCnly_tpcmom);
   ...
   fChain->SetBranchAddress("fTrackTPCnly.ncross", fTrackTPCnly_ncross, &b_fTrackTPCnly_ncross);
   fChain->SetBranchAddress("fTrackTPCnly.chi2ndf", fTrackTPCnly_chi2ndf, &b_fTrackTPCnly_chi2ndf);
